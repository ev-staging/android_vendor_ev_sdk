                ...
                switch (requestType) {
                    ...
                    case RequestInfo.TYPE_WEATHER_BY_WEATHER_LOCATION_REQ:
                        ...
                        mClient.setServiceRequestState(mInfo, result,
                                WeatherManager.WEATHER_REQUEST_COMPLETED);
                        break;
                    case RequestInfo.TYPE_LOOKUP_CITY_NAME_REQ:
                        if (result.getLocationLookupList() == null) {
                            ...
                            mClient.setServiceRequestState(mInfo, null,
                                    WeatherManager.LOOKUP_REQUEST_NO_MATCH_FOUND);
                        } else {
                            mClient.setServiceRequestState(mInfo, result,
                                    WeatherManager.LOOKUP_REQUEST_COMPLETED);
                        }
                        break;
                }
        ...
        if (!mCancelled) {
            try {
                ...
                switch (requestType) {
                    ...
                    case RequestInfo.TYPE_WEATHER_BY_WEATHER_LOCATION_REQ:
                        mClient.setServiceRequestState(mInfo, null,
                                WeatherManager.WEATHER_REQUEST_FAILED);
                        break;
                    case RequestInfo.TYPE_LOOKUP_CITY_NAME_REQ:
                        mClient.setServiceRequestState(mInfo, null,
                                WeatherManager.LOOKUP_REQUEST_FAILED);
                        break;
                }
            } catch (RemoteException e) {
            }
