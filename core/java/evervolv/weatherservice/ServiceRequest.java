...
public final class ServiceRequest {
     ...
     * @return {@link evervolv.weather.RequestInfo}
     */
                    ...
                    switch (requestType) {
                        ...
                        case RequestInfo.TYPE_WEATHER_BY_WEATHER_LOCATION_REQ:
                            ...
                            mClient.setServiceRequestState(mInfo, result,
                                    WeatherManager.RequestStatus.COMPLETED);
                            break;
                        case RequestInfo.TYPE_LOOKUP_CITY_NAME_REQ:
                            if (result.getLocationLookupList() == null
                                ...
                                mClient.setServiceRequestState(mInfo, null,
                                        WeatherManager.RequestStatus.NO_MATCH_FOUND);
                            } else {
                                mClient.setServiceRequestState(mInfo, result,
                                        WeatherManager.RequestStatus.COMPLETED);
                            }
            ...
            if (mStatus.equals(Status.IN_PROGRESS)) {
                try {
                    ...
                    switch (requestType) {
                        ...
                        case RequestInfo.TYPE_WEATHER_BY_WEATHER_LOCATION_REQ:
                            mClient.setServiceRequestState(mInfo, null,
                                    WeatherManager.RequestStatus.FAILED);
                            break;
                        case RequestInfo.TYPE_LOOKUP_CITY_NAME_REQ:
                            mClient.setServiceRequestState(mInfo, null,
                                    WeatherManager.RequestStatus.FAILED);
     ...
     * <ul>
     * <li>{@link cyanogenmod.weather.WeatherManager.RequestStatus#SUBMITTED_TOO_SOON}</li>
     * <li>{@link cyanogenmod.weather.WeatherManager.RequestStatus#ALREADY_IN_PROGRESS}</li>
     * </ul>
