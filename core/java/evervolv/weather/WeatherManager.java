...
public class WeatherManager {
    ...
    private static IWeatherManager sWeatherManagerService;
    ...
    private WeatherManager(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
                ContextConstants.Features.WEATHER_SERVICES) && (sWeatherManagerService == null)) {
            throw new RuntimeException("Unable to bind the WeatherManagerService");
        }
        mHandler = new Handler(appContext.getMainLooper());
    }

    /**
     * Gets or creates an instance of the {@link evervolv.weather.WeatherManager}
     * @param context
     * @return {@link WeatherManager}
     */
    ...
    /** @hide */
    public static IWeatherManager getService() {
        if (sWeatherManagerService != null) {
            return sWeatherManagerService;
        }
        IBinder binder = ServiceManager.getService(ContextConstants.WEATHER_SERVICE);
        if (binder != null) {
            sWeatherManagerService = IWeatherManager.Stub.asInterface(binder);
            return sWeatherManagerService;
        }
        return null;
    }
     ...
     *
     * @param weatherLocation A {@link evervolv.weather.WeatherLocation} that was previously
     *                        obtained by calling
