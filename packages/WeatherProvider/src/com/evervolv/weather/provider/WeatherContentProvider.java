...
package com.evervolv.weather.provider;
...
import evervolv.provider.WeatherContract.WeatherColumns;
import evervolv.weather.WeatherInfo;
import evervolv.weather.WeatherInfo.DayForecast;

import java.util.ArrayList;

import static evervolv.provider.WeatherContract.WeatherColumns.CURRENT_CITY;
import static evervolv.provider.WeatherContract.WeatherColumns.CURRENT_CONDITION;
import static evervolv.provider.WeatherContract.WeatherColumns.CURRENT_CONDITION_CODE;
import static evervolv.provider.WeatherContract.WeatherColumns.CURRENT_HUMIDITY;
import static evervolv.provider.WeatherContract.WeatherColumns.CURRENT_TEMPERATURE;
import static evervolv.provider.WeatherContract.WeatherColumns.CURRENT_TEMPERATURE_UNIT;
import static evervolv.provider.WeatherContract.WeatherColumns.CURRENT_TIMESTAMP;
import static evervolv.provider.WeatherContract.WeatherColumns.CURRENT_WIND_DIRECTION;
import static evervolv.provider.WeatherContract.WeatherColumns.CURRENT_WIND_SPEED;
import static evervolv.provider.WeatherContract.WeatherColumns.CURRENT_WIND_SPEED_UNIT;
import static evervolv.provider.WeatherContract.WeatherColumns.FORECAST_CONDITION;
import static evervolv.provider.WeatherContract.WeatherColumns.FORECAST_CONDITION_CODE;
import static evervolv.provider.WeatherContract.WeatherColumns.FORECAST_HIGH;
import static evervolv.provider.WeatherContract.WeatherColumns.FORECAST_LOW;
import static evervolv.provider.WeatherContract.WeatherColumns.TODAYS_HIGH_TEMPERATURE;
import static evervolv.provider.WeatherContract.WeatherColumns.TODAYS_LOW_TEMPERATURE;
